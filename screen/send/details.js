...
import { BlueButton, BlueDismissKeyboardInputAccessory, BlueListItem, BlueLoading, BlueSpacing20, BlueText } from '../../BlueComponents';
...
const SendDetails = () => {
  ...
  const stylesHook = StyleSheet.create({
    ...
    feeModalTime: {
      backgroundColor: colors.alternativeTextColor2,
    },
    feeModalTimeText: {
